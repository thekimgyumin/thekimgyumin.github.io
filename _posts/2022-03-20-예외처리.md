...
| 대표 예외 | Exception의 상속받는 하위 클래스 중<br>RuntimeException을 제외한 모든 예외<br><ul><li>IOException</li><li>SQLException| RuntimeException 하위 예외<br><ul><li>NullPointerException</li><li>IllegalArgumentException</li><li>IndexOutOfBoundException|
